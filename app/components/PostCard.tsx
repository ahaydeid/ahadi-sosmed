...
import { Eye, Heart, MessageCircle, X, User, MoreVertical, Edit, Trash, Repeat2, Clock, MinusCircle } from "lucide-react";
      ...
      <div className="flex flex-row items-center mt-4 text-gray-500 text-sm">
        <div className="flex items-center gap-x-4">
          <div className="flex items-center gap-1 shrink-0">
            ...
            <span className="text-[11px]">{formatReadingTime(post.description).replace(" menit baca", " min")}</span>
          </div>
          <div className="flex items-center gap-1 shrink-0">
          ...
          <div className="flex items-center gap-1 shrink-0">
            ...
            <span title={String(post.views)} className="text-[11px]">{formatCompact(post.views)}</span>
          </div>
          <div className="flex items-center gap-1 shrink-0">
            <Heart className="w-4 h-4" />
            <span title={String(post.likes)} className="text-[11px]">{formatCompact(post.likes)}</span>
          </div>
          <div className="flex items-center gap-1 shrink-0">
            <MessageCircle className="w-4 h-4" />
            <span title={String(post.comments)} className="text-[11px]">{formatCompact(post.comments)}</span>
          </div>
        </div>
